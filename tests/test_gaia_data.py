...
def run_and_visualize_gaia(
    data_path="data/gaia_data_500.csv",
    ...
    Args:
        data_path: Path to the GAIA data file
    ...
    # Optional smart sampling (GAIA has no spatial coords, spatial/hybrid fall back to expression)
